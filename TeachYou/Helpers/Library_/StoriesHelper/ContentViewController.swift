...
class ContentViewController: UIViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let startingViewController: StoriesVC = viewControllerAtIndex(index: currentIndex)!
    ...
    {
        var index = (viewController as! StoriesVC).pageIndex
    ...
    //3
    func viewControllerAtIndex(index: Int) -> StoriesVC? {
    ...
    func goNextPage(fowardTo position: Int) {
        if let startingViewController: StoriesVC = viewControllerAtIndex(index: position) {
            let viewControllers = [startingViewController]
