...
public final class ViewPagerTabView: UIView {
    ...
    fileprivate func setupBasicTab(condition:SetupCondition, options:ViewPagerOptions, tab:ViewPagerTab) {
        ...
        case .distributeNormally:
            ...
            titleLabel?.frame = CGRect(x: 0, y: 0, width: labelWidth + 10, height: currentFrame.height)
        }
    ...
    fileprivate func setupImageTab(condition:SetupCondition, withText:Bool, options:ViewPagerOptions, tab:ViewPagerTab) {
        ...
        case .distributeNormally:
            ...
            if withText {
                ...
                let textHeight:CGFloat = options.tabViewHeight - yTextPosition - options.tabIndicatorViewHeight
                titleLabel?.frame = CGRect(x: xTextPosition, y: yTextPosition, width: tabWidth + 10, height: textHeight)
    ...
    internal func updateFrame(atIndex index:Int, withWidth width:CGFloat, options:ViewPagerOptions) {
        ...
        let tabViewNewFrame = CGRect(x: tabViewXPosition + 1, y: tabViewCurrentFrame.origin.y, width: width, height: tabViewCurrentFrame.height)
        ...
        case .basic:
            ...
            titleLabel?.frame = CGRect(x: 0, y: 0, width: self.frame.size.width + 10, height: self.frame.size.height)
        ...
        case .imageWithText:
            ...
            let textHeight:CGFloat = options.tabViewHeight - yTextPosition - options.tabIndicatorViewHeight
            titleLabel?.frame = CGRect(x: xTextPosition, y: yTextPosition, width: width + 10, height: textHeight)
