...
public class ViewPagerOptions {
    ...
    public var tabViewBackgroundDefaultColor:UIColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
    public var tabViewBackgroundHighlightColor:UIColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
    public var tabViewTextDefaultColor:UIColor = UIColor.black
    public var tabViewTextHighlightColor:UIColor = UIColor.black
    
    // Booleans
    
    /// Width of each tab is equal to the width of the largest tab. Tabs are laid out from Left - Right and are scrollable
    public var isEachTabEvenlyDistributed:Bool = true
    ...
    public var tabViewPaddingLeft:CGFloat = 0.0
    public var tabViewPaddingRight:CGFloat = 0.0
    public var tabViewTextFont:UIFont = UIFont.systemFont(ofSize: 13, weight: .regular)// UIFont.systemFont(ofSize: 16)
    ...
    public var tabIndicatorViewBackgroundColor:UIColor = #colorLiteral(red: 0.5832950473, green: 0, blue: 0.1457252502, alpha: 1)
    ...
    fileprivate struct Color {
        ...
        static let tabViewBackground = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
        static let tabViewHighlight = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
        static let textDefault = UIColor.black
        static let textHighlight = UIColor.black
        static let tabIndicator = #colorLiteral(red: 0.5843137255, green: 0, blue: 0.1450980392, alpha: 1)
    }
}
