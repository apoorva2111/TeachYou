...
class GoingEventsVC: UIViewController {
    ...
    func getGoingEvents() {
        ...
        let parameters: [String: Any] = [
            "action" : "getEvents",
            "user" : "1", // UserSessionManager.shared.getUserId() ?? "",
            "filter" : filter
        ]
...
extension GoingEventsVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.setGoCellData(data: self.eventsModel[indexPath.row])
        cell.selectedEventId = "\(self.eventsModel[indexPath.row].event_id ?? 0)"
...
extension GoingEventsVC: EventCellDelegate {
