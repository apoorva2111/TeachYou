...
class StudyEventsVC: UIViewController {
...
extension StudyEventsVC: UITableViewDelegate, UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return self.eventsModel.count
    }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        vc.eventName = self.eventsModel[indexPath.row].event_title ?? ""
        self.navigationController?.pushViewController(vc, animated: true)
    }
    
}

extension StudyEventsVC: EventCellDelegate {
